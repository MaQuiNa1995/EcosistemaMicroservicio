package maquina1995.eureka.cliente.anime.info;
...
public class InformacionMicroServicio implements InfoContributor {
	...
	mapainformacion.put("description",
		"Este microservicio es un simple ejemplo que expone endpoints para ser consumidos por otro webservice y por un navegador:");

	Map<String, String> endPointsMapa = new TreeMap<>();
